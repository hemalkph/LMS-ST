...
<head>
    ...
    <title>EduLearn - Your Gateway to Knowledge</title>
...
<body class="landing">
        ...
        <div class="hero-container">
            <div class="hero-content">
                ...
                <div class="hero-buttons">
                    <a href="dashboard.php" class="btn btn-primary btn-large">Start Learning Today</a>
        ...
        <div class="container">
            ...
            <div class="courses-grid">
                <div class="card-container">
                    <div class="course-card">
                        <div class="course-image">
                            <img src="https://images.unsplash.com/photo-1461749280684-dccba630e2f6?q=80&w=2560&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
                ...
                <div class="card-container">
                    <div class="course-card">
                        <div class="course-image">
                            <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=2560&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
    ...
    <section id="results" class="results">
        <div class="container">
            ...
            $results = [
                ...
                [ 'rank' => 7, 'name' => 'RAJITHA MADHUSHAN', 'district' => 'VAVUNIYA District', 'index' => '4161670', 'stream' => 'E.TECH' ],
                ...
                [ 'rank' => 3, 'name' => 'PASINDU ATHUKORALA', 'district' => 'COLOMBO District', 'index' => '1651201', 'stream' => 'ICT' ],
            ...
            <div class="testimonials-grid">
                <div class="testimonial-card">
                    <div class="testimonial-content">
                        <p>"EduLearn transformed my career. The interactive courses and expert instructors helped me land my dream job in tech."</p>
                    </div>
                ...
                <div class="testimonial-card">
                    <div class="testimonial-content">
                        <p>"The self-paced learning approach was perfect for my busy schedule. I could learn at my own speed and still get excellent support."</p>
                    </div>
                    <div class="testimonial-author">
                        <div class="author-avatar">
                            <i class="fas fa-user"></i>
                ...
                <div class="testimonial-card">
                    <div class="testimonial-content">
                        <p>"The community support and live sessions made learning engaging and fun. I never felt alone in my learning journey."</p>
                    </div>
                    <div class="testimonial-author">
                        <div class="author-avatar">
                            <i class="fas fa-user"></i>
    ...
    <section id="cta" class="cta">
        <div class="container">
            <div class="cta-content">
                ...
                <p>Join thousands of students who are already advancing their careers with EduLearn</p>
    ...
    <script>
        ...
        function showDemo() {
            ...
            const videoUrl = (window.DEMO_VIDEO_URL || 'https://www.youtube.com/embed/dQw4w9WgXcQ?rel=0&autoplay=1');
            ...
            modal.innerHTML = `
                ...
                ">
                    ...
                    <div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; border-radius: 12px; background: #000; margin-bottom: 20px; box-shadow: 0 10px 24px rgba(0,0,0,0.12);">
                        <iframe src="${videoUrl}" title="EduLearn Demo Video" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: 0; border-radius: 12px;" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    </div>
